                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col s12">
                          ...
                          <div class="input-field inline">
                              <input id="matricula_inline" type="text" class="validate" required value="{{$unidad->matricula}}">
                    ...
                    <div class="row">
                        <div class="col s12">
                          Modelo:
                          <div class="input-field inline">
                               <input id="modelo_inline" type="text" class="validate" required value="{{$unidad->modelo}}">
                    ...
                    <div class="row">
                        <div class="col s12">
                          Marca:
                          <div class="input-field inline">
                              <input id="marca_inline" type="text" class="validate" required value="{{$unidad->marca}}">
                    ...
                    <div class="row">
                        <div class="col s12">
                          Modelo del motor:
                          <div class="input-field inline">
                              <input id="modelo_del_motor_inline" type="text" class="validate" required value="{{$unidad->modelo_del_motor}}">
                    ...
                    <div class="row">
                        <div class="col s12">
                          Combustible:
                          <div class="input-field inline">
                              <input id="combustible_inline" type="text" class="validate" required value="{{$unidad->combustible}}">
